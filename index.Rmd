...
## Variables
```{r}
variables <- matrix(c("QUESTION ASKED", "Does your health in any way limit your daily activities compared to most people of your age?","If you could choose, would you stay here in your present home or would you prefer to move somewhere else?","Does your accommodation have any of the following problems? Vandalism or crime in the area","Education", "Have you recently felt capable of making decisions about things?","Have you recently felt you couldn’t overcome your difficulties?","Have you recently been able to face up to problems?", "Tell me which things you (and your household) have or do? Pay for a week’s annual holiday away from home.","Would you like to be able to pay for a week’s annual holiday away from home, but must do without because you cannot afford it?", "Tell me which things you (and your household) have or do? Buy new, rather than second hand, clothes.","Would you like to be able to buy new, rather than second hand, clothes, but must do without because you cannot afford it?","Tell me which things you (and your household) have or do? Have friends or family for a drink or meal at least once a month","Have you recently felt that you were playing a useful part in things?", "Did you vote in this (past) year’s general election?","How dissatisfied or satisfied are you with your life overall?"), ncol = 1, byrow =TRUE)
colnames(variables) <- c("BHPS 2000")
rownames(variables) <- c("VARIABLE NAME", "JHLLT", "JLKMOVE", "JHSPRBQ","JQFEDHI", "JGHQD", "JGHQF", "JGHQH","JHSCANB" , "JHSCNTB","JHSCAND", "JHSCNTD", "JHSCANF", "JGHQC", "JVOTE7", "JLFSATO" )
...
hist(BHPS$JHLLT)
BHPS$JHLLT[BHPS$JHLLT == 1] <- "yes"
BHPS$JHLLT[BHPS$JHLLT == 2] <- "no"
BHPS$JHLLT <- as.character(BHPS$JHLLT)

p <- ggpairs(BHPS, mapping = aes(col=JHLLT, alpha = 0.3), lower = list(combo = wrap("facethist", bins = 20)))
p
